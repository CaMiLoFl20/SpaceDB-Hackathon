...
const tablesSchema = __schema({
  marketNews: __table({
    ...
    constraints: [
      { name: 'market_news_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, MarketNewsRow),
  playerDirectory: __table({
    ...
    indexes: [
      ...
      { accessor: 'owner', name: 'player_directory_owner_idx_btree', algorithm: 'btree', columns: [
        'owner',
      ] },
    ],
    constraints: [
      { name: 'player_directory_name_key_key', constraint: 'unique', columns: ['nameKey'] },
      { name: 'player_directory_owner_key', constraint: 'unique', columns: ['owner'] },
    ],
  }, PlayerDirectoryRow),
  recentTrade: __table({
    name: 'recent_trade',
    indexes: [
      { accessor: 'id', name: 'recent_trade_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'recent_trade_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, RecentTradeRow),
  stock: __table({
    name: 'stock',
